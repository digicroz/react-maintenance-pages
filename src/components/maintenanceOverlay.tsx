...
/**
 * Configuration for the maintenance overlay display
 */
...
/**
 * Customization options for the maintenance overlay appearance
 */
export interface MaintenanceOverlayCustomization {
    /** Custom title (default: "Site Under Maintenance") */
    title?: string;
    /** Custom subtitle message (default: "Please visit us on mobile or try again later.") */
    subtitle?: string;
    /** Show loading spinner (default: true) */
    showSpinner?: boolean;
    /** Show "Thank you" message (default: true) */
    showThankYou?: boolean;
    /** Only show on desktop (default: true - uses md: breakpoint) */
    desktopOnly?: boolean;
    /** Custom CSS classes for the overlay container */
    className?: string;
    /** Custom icon element to replace the default SVG */
...
export interface MaintenanceOverlayProps {
    ...
    customization?: MaintenanceOverlayCustomization;
}
            ...
            <div className="text-center text-white px-4 sm:px-6 md:px-8 lg:px-10 max-w-7xl mx-auto w-full">
                ...
                {showThankYou && (
                    <div className="mt-8 sm:mt-10 md:mt-12 text-xs sm:text-sm md:text-base text-green-300 px-2">
                        ...
                        <p className="mt-1 sm:mt-2">- The {companyData.fullName} Team</p>
                    </div>
                )}
            </div>
        </div>
